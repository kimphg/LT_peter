...
//    void on_toolButton_replay_fast_clicked(bool checked);
    ...
    void on_toolButton_ais_request_clicked(bool checked);

    void on_toolButton_adsb_request_clicked(bool checked);

    void on_toolButton_view_ais_clicked(bool checked);
